...
#ifndef TPS_RL_GALLERY_VR_GRAPHICOBJECTCONVERTER_H_
#define TPS_RL_GALLERY_VR_GRAPHICOBJECTCONVERTER_H_
...
class TPS_RL_DECLSPEC TpsGalleryVRGOConverter : public TpsGOConverterBase{
public:
    //the constructor and destructor
    TpsGalleryVRGOConverter(GO_TYPE goType);
    ~TpsGalleryVRGOConverter();
...
protected:
    std::shared_ptr<Mcsf::MedViewer3D::GraphicObjectVolumeRendering> m_spVolumeRendering;

    // the default copy and assign method are not allowed.
    TPS_DISALLOW_COPY_AND_ASSIGN(TpsGalleryVRGOConverter);
};
