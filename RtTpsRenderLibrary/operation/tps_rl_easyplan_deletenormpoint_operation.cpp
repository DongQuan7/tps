...
TpsEasyPlanDeleteNormPointOperation::TpsEasyPlanDeleteNormPointOperation(const std::string& strImageUid, const std::string& strPlanUid, const std::string &strPoiUid):
m_strImageUid(strImageUid), m_strPlanUid(strPlanUid), m_strPoiUid(strPoiUid) {

}

TpsEasyPlanDeleteNormPointOperation::~TpsEasyPlanDeleteNormPointOperation() {

}

bool TpsEasyPlanDeleteNormPointOperation::ModifyGraphicObject() const {
