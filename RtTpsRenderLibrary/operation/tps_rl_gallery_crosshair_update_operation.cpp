...
///
///  \file    tps_gallery_rl_crosshair_update_operation.cpp
...
TpsGalleryCrosshairUpdateOperation::TpsGalleryCrosshairUpdateOperation(ModelWarehouse* modelWarehouse, const std::string& imageUID)
    :m_strImageUID(imageUID),
    mModelWarehouse(modelWarehouse){
}

TpsGalleryCrosshairUpdateOperation::~TpsGalleryCrosshairUpdateOperation(){

}
bool TpsGalleryCrosshairUpdateOperation::ModifyGraphicObject() const{
    ...
    auto goType = GOTypeHelper::ComposeAsGOType(GALLERY_MPR, CORONAL);
    ...
    goType = GOTypeHelper::ComposeAsGOType(GALLERY_CROSSHAIR, CORONAL);
    ...
    goType = GOTypeHelper::ComposeAsGOType(GALLERY_CROSSHAIR, SAGITTAL);
    strKey = m_strImageUID + "|" + GOTypeHelper::ToString(goType);
    go = mModelWarehouse->GetModelObject(strKey);
    ...
    goType = GOTypeHelper::ComposeAsGOType(GALLERY_CROSSHAIR, AXIAL);
    strKey = m_strImageUID + "|" + GOTypeHelper::ToString(goType);
    go = mModelWarehouse->GetModelObject(strKey);
...
bool TpsGalleryCrosshairUpdateOperation::GetTwoPointFromLine(Mcsf::MedViewer3D::Vector3D &normal1, Mcsf::MedViewer3D::Point3D &pt1, Mcsf::MedViewer3D::Vector3D &normal2, Mcsf::MedViewer3D::Point3D &pt2, Mcsf::MedViewer3D::Point3D &outPoint1, Mcsf::MedViewer3D::Point3D &outPoint2) const
{
