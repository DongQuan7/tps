...
/// 
///  \file tps_rl_gallery_volume4d_mpr_renderstrategy.cpp
/// 
///  \brief class GalleryVolume4dMprRenderStrategy implementation 
/// 
///  \version 1.0
/// 
///  \date    2017/03/22
...
GalleryVolume4dMprRenderStrategy::GalleryVolume4dMprRenderStrategy()
...
void GalleryVolume4dMprRenderStrategy::Render_i()
{
    if (mIs4DEnabled)
    {
...
int GalleryVolume4dMprRenderStrategy::CacheChanges()
{
    if (mIs4DEnabled)
    {
