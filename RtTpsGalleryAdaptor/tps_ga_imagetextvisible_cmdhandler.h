...
///  \{
//////////////////////////////////////////////////////////////////////////
#ifndef TPS_GA_IMAGETEXTVISIBLE_CMDHANDLER_H_
#define TPS_GA_IMAGETEXTVISIBLE_CMDHANDLER_H_
...
class TpsGaImageTextVisibleCmdHandler : public IGalleryCmdHandler 
{
public:
    //the constructor and destructor
    TpsGaImageTextVisibleCmdHandler(IGalleryController *galleryController);
    virtual ~TpsGaImageTextVisibleCmdHandler();

    virtual int HandleCommand(const Mcsf::CommandContext *pContext, std::string *pReplyObject);

private:
    // the default copy and assign method are not allowed.
    TPS_DISALLOW_COPY_AND_ASSIGN(TpsGaImageTextVisibleCmdHandler);
};
