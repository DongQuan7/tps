...
///  \date    Apr. 22, 2015
/////////////////////////////////////////////////////////////////
#ifndef TPS_GA_DELETESLICE_CMDHANDLER_H_
#define TPS_GA_DELETESLICE_CMDHANDLER_H_
...
class TpsGaDeleteCurrentSliceCmdHandler : public IGalleryCmdHandler 
{
public:
    //the constructor and destructor
    TpsGaDeleteCurrentSliceCmdHandler(IGalleryController *galleryController);
    virtual ~TpsGaDeleteCurrentSliceCmdHandler();

    virtual int HandleCommand(const Mcsf::CommandContext *pContext, std::string *pReplyObject);

private:
    // the default copy and assign method are not allowed.
    TPS_DISALLOW_COPY_AND_ASSIGN(TpsGaDeleteCurrentSliceCmdHandler);
};
