...
///  \date    Dec. 29, 2014
/////////////////////////////////////////////////////////////////
#ifndef TPS_GA_LEAVINGMODULE_CMDHANDLER_H_
#define TPS_GA_LEAVINGMODULE_CMDHANDLER_H_
...
class TpsGaLeavingModuleCmdHandler : public IGalleryCmdHandler 
{
public:
    //the constructor and destructor
    TpsGaLeavingModuleCmdHandler(IGalleryController *galleryController);
    virtual ~TpsGaLeavingModuleCmdHandler();

    virtual int HandleCommand(const Mcsf::CommandContext *pContext, std::string *pReplyObject);

private:
    // the default copy and assign method are not allowed.
    TPS_DISALLOW_COPY_AND_ASSIGN(TpsGaLeavingModuleCmdHandler);
};
