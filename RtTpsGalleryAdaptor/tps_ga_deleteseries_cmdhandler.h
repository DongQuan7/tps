...
///  \date    Apr. 03, 2015
/////////////////////////////////////////////////////////////////
#ifndef TPS_GA_DELETESERIES_CMDHANDLER_H_
#define TPS_GA_DELETESERIES_CMDHANDLER_H_
...
class TpsGaDeleteSeriesCmdHandler : public IGalleryCmdHandler 
{
public:
    //the constructor and destructor
    TpsGaDeleteSeriesCmdHandler(IGalleryController *galleryController);
    virtual ~TpsGaDeleteSeriesCmdHandler();

    virtual int HandleCommand(const Mcsf::CommandContext *pContext, std::string *pReplyObject);

private:
    // the default copy and assign method are not allowed.
    TPS_DISALLOW_COPY_AND_ASSIGN(TpsGaDeleteSeriesCmdHandler);
};
