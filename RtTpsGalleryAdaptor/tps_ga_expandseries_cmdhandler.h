...
///  \date    Apr. 03, 2015
/////////////////////////////////////////////////////////////////
#ifndef TPS_GA_EXPANDSERIES_CMDHANDLER_H_
#define TPS_GA_EXPANDSERIES_CMDHANDLER_H_
...
class TpsGaExpandSeriesCmdHandler : public IGalleryCmdHandler 
{
public:
    //the constructor and destructor
    TpsGaExpandSeriesCmdHandler(IGalleryController *galleryController);
    virtual ~TpsGaExpandSeriesCmdHandler();

    virtual int HandleCommand(const Mcsf::CommandContext *pContext, std::string *pReplyObject);

private:
    // the default copy and assign method are not allowed.
    TPS_DISALLOW_COPY_AND_ASSIGN(TpsGaExpandSeriesCmdHandler);
};
